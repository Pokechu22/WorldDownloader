...
public class StorageMinecartHandler extends EntityHandler<EntityMinecartChest, ContainerChest> {
	...
	@Override
	public String copyData(ContainerChest container, EntityMinecartChest minecart, boolean riding) throws HandlerException {
		...
		return "wdl.messages.onGuiClosedInfo.savedEntity.storageMinecart";
	}
