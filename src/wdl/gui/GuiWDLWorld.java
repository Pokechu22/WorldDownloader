...
public class GuiWDLWorld extends GuiScreen {
	...
	public void initGui() {
		...
		y += 22;
		this.spawnTextY = y + 4;
		this.spawnX = new GuiNumericTextField(this.fontRendererObj, this.width / 2 - 87,
				y, 50, 16);
		this.spawnY = new GuiNumericTextField(this.fontRendererObj, this.width / 2 - 19,
				y, 50, 16);
		this.spawnZ = new GuiNumericTextField(this.fontRendererObj, this.width / 2 + 48,
				y, 50, 16);
