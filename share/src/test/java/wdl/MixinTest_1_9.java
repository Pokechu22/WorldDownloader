 ...
 *
 * NOTE: This version is used in 1.9.0 only (and the corresponding NoMixin one
 * in 1.9.0 and 1.9.2), as the class name difference only applies there.
 * 1.9.4 uses the 1.10 version.
 */
