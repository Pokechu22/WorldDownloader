...
public class BlastFurnaceTest extends AbstractBlockHandlerTest<BlastFurnaceTileEntity, BlastFurnaceContainer, BlastFurnaceHandler> {

	public BlastFurnaceTest() {
		super(BlastFurnaceTileEntity.class, BlastFurnaceContainer.class, BlastFurnaceHandler.class);
	}

	@Test
	public void testBlastFurance() throws HandlerException {
		BlockPos pos = new BlockPos(0, 0, 0);
		makeMockWorld();
		placeBlockAt(pos, Blocks.BLAST_FURNACE);
		BlastFurnaceTileEntity te = makeBlockEntity(pos);
	...
	public void testCustomName() throws HandlerException {
		...
		placeBlockAt(pos, Blocks.BLAST_FURNACE);
		BlastFurnaceTileEntity te = makeBlockEntity(pos);
		te.setCustomName(customName("Blasted Furni"));
	...
	public void testCustomNameVanilla() throws HandlerException {
		...
		placeBlockAt(pos, Blocks.BLAST_FURNACE);
		BlastFurnaceTileEntity te = makeBlockEntity(pos);
		te.setCustomName(customName("Blast Furnace"));
