...
public class GuiWDLChunkOverrides extends GuiScreen {
	...
	public void initGui() {
		...
		this.x1Field = new GuiNumericTextField(fontRendererObj,
				this.width / 2 - 138, 18, 33, 20);
		this.z1Field = new GuiNumericTextField(fontRendererObj,
				this.width / 2 - 87, 18, 33, 20);
		this.x2Field = new GuiNumericTextField(fontRendererObj,
				this.width / 2 - 36, 18, 33, 20);
		this.z2Field = new GuiNumericTextField(fontRendererObj,
	...
	public void drawScreen(int mouseX, int mouseY, float partialTicks) {
		...
		this.drawString(fontRendererObj, "X1:", this.width / 2 - 138 - 16, 24, 0xFFFFFF);
		this.drawString(fontRendererObj, "Z1:", this.width / 2 - 87 - 16, 24, 0xFFFFFF);
		this.drawString(fontRendererObj, "X2:", this.width / 2 - 36 - 16, 24, 0xFFFFFF);
		this.drawString(fontRendererObj, "Z2:", this.width / 2 + 15 - 16, 24, 0xFFFFFF);
