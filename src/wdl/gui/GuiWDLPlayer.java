...
public class GuiWDLPlayer extends GuiScreen {
	...
	public void initGui() {
		...
		y += 22;
		this.posTextY = y + 4;
		this.posX = new GuiNumericTextField(this.fontRendererObj,
				this.width / 2 - 87, y, 50, 16);
		this.posY = new GuiNumericTextField(this.fontRendererObj,
				this.width / 2 - 19, y, 50, 16);
		this.posZ = new GuiNumericTextField(this.fontRendererObj,
